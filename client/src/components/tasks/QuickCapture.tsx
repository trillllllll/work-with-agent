...
export function QuickCapture({ topicId, parentId = null, onCreate, inbox, disabled }: Props) {
  ...
  return <form onSubmit={submit} className="glass-subtle flex gap-2 rounded-2xl p-3" aria-label={parentId ? '添加子任务' : '快速录入'}>
